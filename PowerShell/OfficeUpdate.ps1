...
# Modifications by R. Visser

# Function for nice progressbar while waiting
...
Write-Host "############################################################################################################" -ForegroundColor Green
Write-Host "Starting the Office 365 update process..." -ForegroundColor Cyan
...
Write-Host "Waiting for the update process to finish..." -ForegroundColor Cyan
Write-Host "############################################################################################################" -ForegroundColor Green
...
Write-Host "############################################################################################################" -ForegroundColor Green
Write-Host "Checking the Office version..." -ForegroundColor Cyan
Write-Host "############################################################################################################" -ForegroundColor Green
